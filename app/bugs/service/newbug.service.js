...
var NewBugService = (function () {
    ...
    NewBugService.prototype.changedListener = function () {
        var _this = this;
        return observable_1.Observable.create(function (obs) {
    ...
    NewBugService.prototype.addBug = function (bug) {
    ...
    NewBugService.prototype.updateBug = function (bug) {
    ...
    NewBugService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [firebase_config_service_1.FirebaseConfigService])
    ], NewBugService);
    return NewBugService;
}());
exports.NewBugService = NewBugService;
//# sourceMappingURL=newbug.service.js.map